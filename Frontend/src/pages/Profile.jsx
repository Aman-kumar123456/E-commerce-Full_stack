      ...
      <div className="bg-white shadow-md rounded-sm p-6 max-w-3xl">
        <div className="flex items-center gap-6">
          <div  className=" flex flex-col gap-2">
            ...
            <form onSubmit={handleformrefresh}>
              <label htmlFor="uploadavatar">
                <div className="text-sm bg-yellow-400 p-1 rounded-md">
                  Uplaoad Profile
                </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <button className="text-sm bg-yellow-400 p-1 rounded-md" onClick={()=>seteditOpen(true)}>Edit Profile</button>
        ...
        {
          editopen &&<Profileedit close={()=>seteditOpen(false)}/>
        }
